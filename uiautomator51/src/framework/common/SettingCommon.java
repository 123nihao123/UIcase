...
public class SettingCommon {
	...
	public static void addContextualModel(String name)
		...
		System.out
				.println("======Start to excute CallContactsCommon: addContextualModel======");
	...
	public static void deleteContextualModel(String name)
			throws UiObjectNotFoundException {
		System.out
				.println("======Start to excute CallContactsCommon: deleteContextualModel======");
	...
	public static void delAllAccountsBySetting()
			throws UiObjectNotFoundException {
		delAllAccountsBySetting("个人");
	}

	public static void delAllAccountsBySetting(String index)
			throws UiObjectNotFoundException {
		UiObject emailAccount = (UiObject) excute(Object_ResourceId,
				Operate_ReturnObject, "android:id/title", "index");
		DeviceCommon.enterApp(Devices_Desc_Setting);
	...
	public static void delAccountBySetting(String userName)
			throws UiObjectNotFoundException {
		delAccountBySetting("个人", userName);
	}

	public static void delAccountBySetting(String index, String userName)
			throws UiObjectNotFoundException {
		DeviceCommon.enterApp(Devices_Desc_Setting);
		excute(Object_TextScroll, Operation_ClickWait, "帐户");
	...
	public static boolean deleteAction(String index, String userName)
			throws UiObjectNotFoundException {
		UiObject addAccount = (UiObject) excute(Object_ResIdText,
				Operate_ReturnObject, "android:id/title", "添加帐户");
	...
	// 开关SIM1
	public static void enableCard(String Turno)
			throws UiObjectNotFoundException {
		try {
			ClearBackgroundApp();
		...
		UiObject index0 = new UiObject(
				new UiSelector().resourceId("android:id/list"))
				.getChild(new UiSelector().index(0));
		UiObject index = index0.getChild(new UiSelector()
				.resourceId("com.android.settings:id/universal_switch"));
	...
	// 开关SIM2
	public static void enableCard2(String Turno)
			throws UiObjectNotFoundException {
		try {
			ClearBackgroundApp();
		} catch (RemoteException e) {
	...
	public static void ConnectVPN(String type, String VPNName, String Password)
			throws UiObjectNotFoundException {
		System.out
				.println("======Start to excute CallContactsCommon: ConnectVPN======");
	...
	public static void ConnectBrowser(String URL)
			throws UiObjectNotFoundException, RemoteException {
		System.out
				.println("======Start to excute CallContactsCommon: ConnectBroswer======");
		ClearBackgroundApp();
		Wait(1000);
		DeviceCommon.enterApp("浏览器");
		UiObject index2 = new UiObject(
				new UiSelector().resourceId("com.android.browser:id/url"));
		// Wait(500);
		excute(Object_ResourceId, Operation_SetText,
				"com.android.browser:id/url", URL);
		// Wait(500);
		UiDevice.getInstance().pressEnter();
		UiObject stop = new UiObject(
				new UiSelector().resourceId("com.android.browser:id/stop"));
		...
		check(Object_ResourceId, Operation_TextEqualTrue, "android:id/matches",
				"0/0");
	...
	public static void EnterMove() throws UiObjectNotFoundException {
		System.out
				.println("======Start to excute CallContactsCommon: EnterMove======");
		excute(Object_Text, Operation_ClickWait, "更多");
	...
	// UiObject index4=new UiObject(new
	// UiSelector().resourceId("android:id/list")).getChild(new
	// UiSelector().index(4));
	// UiObject index2=new UiObject(new
	// UiSelector().resourceId("android:id/list")).getChild(new
	// UiSelector().index(2));
	// if(index4.exists()){
	...
	public static void Select4date() throws UiObjectNotFoundException {
		System.out
				.println("======Start to excute CallContactsCommon: Selectdate======");
		UiObject index2 = new UiObject(
				new UiSelector().resourceId("android:id/list"))
	...
	public static void SendMS(String Num) throws UiObjectNotFoundException {
		...
		Wait(500);
		excute(Object_ResourceId, Operation_SetText,
				"com.android.messaging:id/recipient_text_view", Num);
		Wait(500);
		excute(Object_Device, Operation_PressEnter);
		Wait(500);
		if ((Boolean) excute(Object_ResourceId, Operation_Exists,
			...
			excute(Object_ResourceId, Operation_SetText,
					"com.android.messaging:id/compose_message_text", "MS");
			Wait(500);
			excute(Object_ResourceId, Operation_ClickWait,
					"com.android.messaging:id/self_send_icon");
		} else {
			excute(Object_Device, Operation_PressEnter);
			Wait(500);
			excute(Object_ResourceId, Operation_SetText,
	...
	public static void SendMMS(String Num) throws UiObjectNotFoundException {
		...
		if ((Boolean) excute(Object_ResourceId, Operation_Exists,
				"com.android.messaging:id/compose_message_text")) {
			excute(Object_ResourceId, Operation_SetText,
					"com.android.messaging:id/compose_message_text", "MMS");
			Wait(500);
			excute(Object_ResourceId, Operation_ClickWait,
					"com.android.messaging:id/attach_media_button");
			Wait(500);
			excute(Object_ResourceId, Operation_ClickWait,
					"com.android.messaging:id/camera_capture_button");
			Wait(500);
			excute(Object_ResourceId, Operation_ClickWait,
					"com.android.messaging:id/self_send_icon");
		} else {
	...
	public static void EnterMoveData() throws UiObjectNotFoundException {
		System.out
				.println("======Start to excute CallContactsCommon: EnterMoveData======");
		try {
			ClearBackgroundApp();
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
	...
	public static void GetMoveData() throws UiObjectNotFoundException,
			RemoteException {
		System.out
				.println("======Start to excute CallContactsCommon: GetMoveData======");
		String Data = (String) excute(Object_ResourceId, Operation_GetText,
				"com.android.settings:id/cycle_summary");
		Wait(500);
	...
	public static void WifiData(String Wifid) throws UiObjectNotFoundException {
		System.out
				.println("======Start to excute CallContactsCommon: OpenWifiData======");
	...
	public static void OpenDaralimit() throws UiObjectNotFoundException {
		System.out
				.println("======Start to excute CallContactsCommon: OpenDaralimit======");
		EnterMoveData();
	...
	public static void CloseDaralimit() throws UiObjectNotFoundException {
		System.out
				.println("======Start to excute CallContactsCommon: CloseDaralimit======");
		EnterMoveData();
		excute(Object_Text, Operation_ClickWait, "设置移动数据流量上限");
		Wait(500);
		if ((Boolean) excute(Object_Text, Operation_Exists, "确定")) {
	...
	public static void DragDaralimit() throws UiObjectNotFoundException {
		...
		excute(Object_ResourceId, Operation_ClickWait,
				"com.android.settings:id/sweep_limit");
		excute(Object_ResourceId, Operation_SetText,
				"android:id/numberpicker_input", "10240");
		excute(Object_Text, Operation_ClickWait, "确定");
		Wait(500);
		excute(Object_ResourceId, Operation_ClickWait,
	...
	public static void unLock() throws UiObjectNotFoundException {
		...
		if ((Boolean) excute(Object_ResourceId, Operation_Exists,
			...
			excute(Object_ResourceId, Operation_SetText,
					"com.android.systemui:id/pinEntry", "1234");
			Wait(500);
			excute(Object_ResourceId, Operation_ClickWait,
					"com.android.systemui:id/key_enter");
		} else
	...
	// 以下为孔皓*******************************************************************************************************
	public static void open_close_auto_date(String open_close)
			throws UiObjectNotFoundException {
		UiObject set_button = (UiObject) excute(Object_ResIdInstance,
				Operate_ReturnObject, "android:id/switchWidget", "0");
		if (set_button.getText().equals(open_close))
			excute(Object_Text, Operation_ClickWait, "自动确定日期和时间");
	}

	public static void set_check_date(String year, String day)
			throws UiObjectNotFoundException {
		// 设置日期
		...
		UiObject year_old = (UiObject) excute(Object_ResourceId,
				Operate_ReturnObject, "android:id/date_picker_header_year");
		UiObject date_old = (UiObject) excute(Object_ResourceId,
				Operate_ReturnObject, "android:id/date_picker_header_date");
		excute(Object_Text, Operation_ClickWait, "确定");
		excute(Object_Text, Operation_ClickWait, "设置日期");
		// 检查日期设置是否正确
		UiObject year_new = (UiObject) excute(Object_ResourceId,
				Operate_ReturnObject, "android:id/date_picker_header_year");
		UiObject date_new = (UiObject) excute(Object_ResourceId,
				Operate_ReturnObject, "android:id/date_picker_header_date");
		check(Object_Text, Operation_TextEqualTrue, year_old.getText(),
				year_new.getText());
		check(Object_Text, Operation_TextEqualTrue, date_old.getText(),
				date_new.getText());
		excute(Object_Device, Operation_PressBack);
	}
	...
	public static void open_close_auto_time_zone(String open_close)
			throws UiObjectNotFoundException {
		UiObject set_button = (UiObject) excute(Object_ResIdInstance,
				Operate_ReturnObject, "android:id/switchWidget", "1");
		if (set_button.getText().equals(open_close))
	...
	public static void set_check_time_zone() throws UiObjectNotFoundException {
		...
		UiObject set_button2 = (UiObject) excute(Object_ResIdInstance,
				Operate_ReturnObject, "android:id/summary", "4");
		// 检查时区
		check(Object_Text, Operation_TextEqualTrue, set_button2.getText(),
				"GMT+08:00 中国标准时间");
	}

	public static void open_close_24_time(String open_close)
			throws UiObjectNotFoundException {
		UiObject set_button3 = (UiObject) excute(Object_ResIdInstance,
				Operate_ReturnObject, "android:id/switchWidget", "2");
	...
	public static void uninstall_apk(String name)
			throws UiObjectNotFoundException {
	...
	public static void change_user_name(String name) {
		excute(Object_ResIdText, Operation_ClickWait, "android:id/summary",
				"机主");
		excute(Object_ResourceId, Operation_SetText,
				"com.android.settings:id/user_name", name);
		excute(Object_Device, Operation_PressBack);
	}

	public static void change_user_photo() {
		excute(Object_ResourceId, Operation_ClickWait,
				"com.android.settings:id/user_photo");
	...
	public static void check_user_name(String name)
			throws UiObjectNotFoundException {
		UiObject set_button = (UiObject) excute(Object_ResIdInstance,
				Operate_ReturnObject, "android:id/title", "1");
	...
	public static void add_user() {
		...
		UiObject add = (UiObject) excute(Object_Text, Operate_ReturnObject,
				"要添加新用户吗？");
		if (add.exists()) {
		...
		excute(Object_Text, Operation_ClickWait, "添加用户");
		UiObject add2 = (UiObject) excute(Object_Text, Operate_ReturnObject,
				"要添加新用户吗？");
		if (add2.exists()) {
			System.out.println("Appear hint when add new user");
			excute(Object_Text, Operation_ClickWait, "确定");
	...
	public static void add_user_with_enter() {
		System.out.println("Add new user:"
				+ excute(Object_Text, Operation_checkExist, "新用户"));
		excute(Object_Text, Operation_ClickWait, "添加用户");
		excute(Object_Text, Operation_ClickWait, "确定");
		excute(Object_Text, Operation_ClickWait, "立即设置");
	}

	public static void add_mail_account(String mail, String info,
			String password, String name) throws UiObjectNotFoundException {
		...
		UiObject mail2 = (UiObject) excute(Object_ResourceId,
				Operate_ReturnObject, "com.android.email:id/account_email");
		mail2.setText(mail);
		excute(Object_Text, Operation_ClickWait, "下一步");
		UiObject password2 = (UiObject) excute(Object_ResourceId,
				Operate_ReturnObject, "com.android.email:id/regular_password");
		...
		UiObject name2 = (UiObject) excute(Object_ResourceId,
				Operate_ReturnObject, "com.android.email:id/account_name");
		name2.setText(name);
		excute(Object_Text, Operation_ClickWait, "下一步");
	}
	...
	public static void set_pic(String info) throws UiObjectNotFoundException {
		...
		if (info.equals("文件管理器")) {
			...
			excute(Object_TextScroll, Operation_ClickWait, "picture.jpg",
					"vertical");
	...
	public static void addWifi(String wifiname, String type, String password)
		...
		if ((Boolean) excute(Object_Text, Operation_Exists, wifiname)) {
			...
			excute(Object_ResourceId, Operation_ClickWait, "android:id/text1",
					type);
			excute(Object_ResIdText, Operation_ClickWait, "android:id/text1",
					type);
			excute(Object_ResourceId, Operation_SetText,
					"com.android.settings:id/password", password);
			excute(Object_ResourceId, Operation_ClickWait,
	...
	public static void checkWifiConnect(String wifiname)
		...
		check(Object_ResourceId, Operation_TextEqualTrue, "android:id/title",
				wifiname);
		check(Object_ResourceId, Operation_TextEqualTrue, "android:id/summary",
				"已连接");
		System.out.println(wifiname);
	}

	public static void checkSaveWifi(String wifiname)
			throws UiObjectNotFoundException {
	...
	public static void Display(String simcard) throws UiObjectNotFoundException {
		String text = "SIM2";
		excute(Object_ResIdInstance, Operation_Exists, "android:id/summary",
				"4", simcard);
		if (simcard == text) {
	...
	public static void Selectdate() throws UiObjectNotFoundException {
		UiObject index3 = new UiObject(
				new UiSelector().resourceId("android:id/list"))
				.getChild(new UiSelector().index(3));
		UiObject index1 = index3.getChild(new UiSelector()
				.resourceId("com.android.settings:id/universal_switch"));
		if (index1.isChecked() == false) {
			index1 = index3.getChild(new UiSelector()
					.resourceId("com.android.settings:id/universal_switch"));
			index1.click();
		}
		Wait(2000);
